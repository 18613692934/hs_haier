...
<!--[if lt IE 9]>
<script type="text/javascript" src="__PUBIC_JS__/html5shiv.js"></script>
<script type="text/javascript" src="__PUBIC_JS__/respond.min.js"></script>
<![endif]-->
...
<!--[if IE 6]>
<script type="text/javascript" src="__PUBIC_JS__/DD_belatedPNG_0.0.8a-min.js" ></script>
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="admin_add('添加管理员','adminAdd','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a></span> <span class="r">共有数据：<strong><?php echo ($list[0]['admin_num']); ?></strong> 条</span> </div>
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
                <?php if(is_array($list)): foreach($list as $key=>$list): ?><tr class="text-c">
				<td><input type="checkbox" value="1" name=""></td>
				<td><?php echo ($list['admin_sort']); ?></td>
				<td><?php echo ($list['admin_id']); ?></td>
				<td><?php echo ($list['admin_login_name']); ?></td>
				<td><?php echo ($list['admin_phone']); ?></td>
				<td><?php echo ($list['admin_email']); ?></td>
				<td></td>
				<td><?php echo (date("Y-m-d H:i",$list['admin_create_time'])); ?></td>
