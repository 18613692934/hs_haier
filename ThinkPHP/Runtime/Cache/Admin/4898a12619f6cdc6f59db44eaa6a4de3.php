...
<div class="page-container">
	...
	<table class="table table-border table-bordered table-hover table-bg">
		...
		<tbody>
                    <?php if(is_array($list)): foreach($list as $key=>$fo): ?><tr class="text-c">
                            <td><input type="checkbox" value="<?php echo ($fo['role_id']); ?>" name="checkbox"></td>
                            <td><?php echo ($fo['role_id']); ?></td>
                            <td><?php echo ($fo['role_name']); ?></td>
                            <td><a href="#">admin</a></td>
                            <td><?php echo ($fo['role_describe']); ?></td>
