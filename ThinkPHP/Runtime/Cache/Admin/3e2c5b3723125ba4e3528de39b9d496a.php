...
<!--[if IE 6]>
<script type="text/javascript" src="/Public/static/DD_belatedPNG_0.0.8a-min.js" ></script>
				...
				<ul class="cl">
					...
					<li id="Hui-skin" class="dropDown right dropDown_hover"> <a href="javascript:;" class="dropDown_A" title="换肤"><i class="Hui-iconfont" style="font-size:18px">&#xe62a;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							...
							<li><a href="javascript:;" data-val="blue" title="蓝色">��色</a></li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
                            <ul>
                                    <li><a data-href="<?php echo U('Inform/informList');?>" data-title="通知公告" href="javascript:void(0)">通知公告</a></li>
                            </ul>
			</dd>
		</dl>
		<dl id="menu-picture">
