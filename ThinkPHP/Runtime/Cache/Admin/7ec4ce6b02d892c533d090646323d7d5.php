    ...
    <form class="form form-horizontal" action="<?php echo U('login');?>" method="post">
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input id="" name="login_name" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img id="verify" src="<?php echo U('Login/verify',array());?>"> <a id="kanbuq" href="javascript::" onclick="refresh_verify()">看不清，换一张</a> </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
...
<script type="text/javascript">
    ...
    function refresh_verify(){
        ...
        document.getElementById('verify').src = "<?php echo U('Login/verify/"+time+"');?>";
    }
</script>
