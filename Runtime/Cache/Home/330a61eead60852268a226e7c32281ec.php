                                ...
                                <div class="diseased-wrap">
                                    ...
                                    <div class="col-md-6">
                                        <div class="widget widget-default">
                                            <div class="widget-body">
                                                ...
                                                <div class="insect-wrap">
                                                    <div class="row">
                                                        <div class="col-md-24">
                                                            <div class="input-group insect-search">
                                                                <input type="text" class="form-control" placeholder="23位安全溯源码查询" id="sourceCode">
                                                                <img src="http://yladc.com/static/data-service/img/search-icon.png" class="serch-icon">
                                                                <span class="input-group-btn ">
                                                                    <button class="btn btn-primary" type="button" onclick="prodDataService.searchSourceCode()">查询</button>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-md-24">
                                        <div class="widget widget-default">
                                            <div class="widget-body">
                                                <div class="head-info clearfix">
                                                    <span>农产品生命周期数据查询</span>
                                                </div>
                                                <div class="inset-classfiy  height-auto">
                                                    <div class="activity-search" id="cropstypelist">
                                                        <div class="dl margin-t-15"><div class="dt">蔬菜</div><div class="dd"><div class="dd-toggle"><a href="#" class="first-child"><span class="on">全部</span></a><a href="<?php echo U('Produce/queryProdDataList');?>"><span>大蒜</span></a></div></div></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
