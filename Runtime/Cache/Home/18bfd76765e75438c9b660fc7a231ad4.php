...
<div class="banner" style="height: 140px;background: url('/Tpl/Home/Public/home/images/policy_banner.jpg') center"></div>
...
<ul class="nav nav-tabs">
    <li class="active"  >
        <a href="<?php echo U('Policy/policy');?>">政策服务</a>
    </li>
    <li>
        <!--<a href="#">农科专家</a>-->
    </li>
         ...
         <div class="item-content"> 
          <div class="item-header"> 
           ...
           <div class="item-title"> 
                <a href="<?php echo U('policy/policy_detail');?>">全力推进 “510”企业培育工程！</a>            
           </div> 
          </div> 
          <div class="item-body">
           <div class="item-info"> 
            ...
            <div class="item-text"> 
             <span>专家：XXX</span> 
             <span>更新时间：<?php echo date('Y-m-d H:m',time()); ?></span> 
            </div> 
            <div>
                特色经济作物
            </div>
